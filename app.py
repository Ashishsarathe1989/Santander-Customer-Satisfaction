...
#url = 'https://github.com/Ashishsarathe1989/Santander-Customer-Satisfaction/blob/main/LGBM_clf.pkl?raw=true'
#with open("LGBM_clf.pkl",'wb') as output_file: output_file.write(requests.get(url).content)
...
#with open("LGBM_clf.pkl", 'rb') as file:  LGBM_ = pickle.load(file)
